...
model_name = 'RO_trained_model_single_10m.h5'
filepath = r"RO_Best_model_single_10m.hdf5"

###########  Data Import #############
Train = r"./data/RO_std_train_samples.npy"
Test = r"./data/RO_std_val_samples.npy"
